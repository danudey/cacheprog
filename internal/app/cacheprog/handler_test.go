...
func TestHandler_ConcurrentOperations(t *testing.T) {
	...
	t.Run("respects max concurrent remote gets", func(t *testing.T) {
		synctest.Test(t, func(t *testing.T) {
			...
			assert.LessOrEqual(t, elapsed, numRequests*remoteGetDelay)
